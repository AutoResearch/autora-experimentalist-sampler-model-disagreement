...
- Create a new repository on GitHub (a sensible name for the repository would be autora-experimentalist-sampler-model-disagreement-sampler)
...
You may now add your code to `src/autora/experimentalist/sampler/model_disagreement_sampler/__init__.py` file. You may 
...
It is highly encouraged to add unit tests to ensure your code is working as intended. These can be [doctests](https://docs.python.org/3/library/doctest.html) or test cases in `tests/test_model_disagreement_sampler.py`.
